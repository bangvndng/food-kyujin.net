...
<?php
 ...
 $counter = (isset($_GET['page'])?$_GET['page'] - 1:0) * $pagination->limit;
 foreach($dataProvider->getData() as $item): ?>
<li><span><?php echo ++$counter; ?></span><a href="<?php echo $this->createUrl('/home/question',array('id' => $item->id)) ?>"><?php if($counter <= 3): ?><img src="/assets/img/rank0<?php echo $counter ?>.gif" alt="<?php echo $counter ?>位" width="14"><?php endif; ?><?php echo $item->title ?></a></li>
