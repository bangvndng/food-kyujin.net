...
<html lang="en">
  <head>
    ...
    <link href="<?php echo Yii::app()->request->baseUrl; ?>/assets/css/main.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <!-- Just for debugging purposes. Don't actually copy this line! -->
    <!--[if lt IE 9]><script src="<?php echo Yii::app()->request->baseUrl; ?>/assets/docs-assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
