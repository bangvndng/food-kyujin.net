...
class Apps extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, fb_app_id, fb_app_key,fb_namespace', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, fb_app_id, fb_app_key,fb_namespace', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'name' => 'Name',
			'fb_app_id' => 'Fb App',
			'fb_app_key' => 'Fb App Key',
			'fb_namespace' => 'Fb Namespace',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('fb_app_key',$this->fb_app_key,true);
		$criteria->compare('fb_namespace',$this->fb_namespace,true);
